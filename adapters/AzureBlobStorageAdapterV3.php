...
/**
 * Adaptador para Flysystem v3 (Laravel 10+ y October CMS v3 reciente)
 */
class AzureBlobStorageAdapterV3 implements FilesystemAdapter
{
    /**
    ...
    public function deleteDirectory(string $path): void
    {
        ...
        try {
            $blobs = iterator_to_array($this->listContents($path, true));
